...
class Trainer():
  def __init__(self, train_loader, test_loader, learning_rate, sample_count, max_det, model_dir, seed):
    ...
    self.seed = seed
    with open('/Users/alaiasolko-breslin/Penn/research/blackbox-learning/scene/scene/yolo_only.pkl', 'rb') as f: 
...
if __name__ == "__main__":
  ...
  data_root = os.path.abspath(os.path.join(os.path.abspath(__file__), "/Users/alaiasolko-breslin/Penn/research/blackbox-learning/data/scene"))
