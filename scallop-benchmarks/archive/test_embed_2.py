...
from experiments.clutrr.archive.run_with_embed_2 import relation_id_map, CLUTRRModel, MLP
...
if __name__ == "__main__":
  ...
  parser.add_argument("--model-name", type=str, default="clutrr_embed_2.latest.model")
