...
class Trainer:
  def __init__(self, train_loader, test_loader, device, model_dir, model_name, learning_rate, rule_learning_rate, **args):
    self.device = device
