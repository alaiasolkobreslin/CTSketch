...
if __name__ == '__main__':
    config = {
        ...
        "perception_lr": 0.0001, # the perception model predicts the image items
        ...
        "pretrain_epochs": 0,
        "prune": False,
        "q_lr": 0.001, # q is the prediction model (computes WMC I)
        "q_loss": "mse",
        "q_model": "path_resnet",
        "rloo_samples": None,
        "rloo_lr": 0.0001,
    ...
    if config_file is not None:
        ...
        with open("/home/alaia/blackbox-learning/sketch-experiments/anesi/experiments/path_planning/sweeps/sweep.yaml", 'r') as f:
