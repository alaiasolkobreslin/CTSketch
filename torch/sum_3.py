...
class MNISTSum3Net(nn.Module):
  def __init__(self, k):
    ...
    self.sum_3 = ised.ISED(bbox=(lambda x1, x2, x3: x1 + x2 + x3), n_samples=k, semiring="add-mult", output_mapping = 28)
  ...
  def forward(self, x: Tuple[torch.Tensor, torch.Tensor, torch.Tensor]):
    ...
    return self.sum_3(a_distrs, b_distrs, c_distrs)
